...
<div class="operationsbox">
	<div class="inside">
		<a href="admin/popup/upload.php" class="button" rel="popcorn"><img style="float:left; border:none; margin:5px 5px 0 0;" src="admin/cosmetics/icons/attach.png" alt="Upload Icon" />Upload File</a>
	</div><!-- /inside -->
	<div class="line"></div>
	<div class="inside">
