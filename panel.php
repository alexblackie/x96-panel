<?php
	if(!isset($_GET['action'])){ //no action defined?
		header("location: ?action=pages"); //Go to dashboard
	}
...
<head>
	...
	<script type="text/javascript" src="admin/scripts/tabcontent.js">
		/***********************************************
...
<body>
	<div class="topbox">
		<div id="logo">
			<a href="panel.php?action=pages"><?php sitename(); ?> &ndash; Administration</a>
		</div><!-- /logo -->
...
?>
		<div class="sidebar">
			<div class="menu">
				...
				<a id="settings" class="settings" href="?action=settings"><div class="menu-img">&nbsp;</div>Settings</a>
...
<?php
	if(isset($_GET['msg'])){
		echo '<div class="msg">';
		if($_GET['msg'] == "pagedeleted"){
			echo '<img class="msgicon" src="admin/cosmetics/icons/check.png" alt="Checkmark Icon" /><strong>The page has been permanently deleted.</strong>';
		}
		elseif($_GET['msg'] == "updated"){
			echo '<img style="border:none; margin:0 5px -3px 0; display:inline;" src="admin/cosmetics/icons/check.png" alt="Checkmark Icon" /><strong>The page has been updated successfully.</strong>';
		}
		elseif($_GET['msg'] == "created"){
			echo '<img class="msgicon" src="admin/cosmetics/icons/check.png" alt="Checkmark Icon" /><strong>The page has been created successfully.</strong>';
		}
		...
		elseif($_GET['msg'] == "filedeleted"){
			echo '<img class="msgicon" src="admin/cosmetics/icons/check.png" alt="Checkmark Icon" /><strong>The file has been deleted successfully.</strong>';
		}
		echo '</div><!-- /msg -->';
	}
?>
